...
public class Welcome02_Object {
   public static void main(String[] args) {
      ...
      */
      System.out.println( "The coldest airport is: " + ob1.coldest(ob2, ob3) );
   }
}
...
class Observation {
   ...
   /* determines coldest of three locations */
 public Observation coldest( Observation b, Observation c ){
   if ( this.colderThan( b ) ){
     if ( this.colderThan( c ) )
        return this;
     return c;
   }
   else if ( b.colderThan(c))
      return b;
   return c;
 }
